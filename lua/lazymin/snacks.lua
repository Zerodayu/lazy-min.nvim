...
function M.apply()
  ...
  vim.api.nvim_set_hl(0, "SnacksDashboardKey", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "SnacksDashboardDesc", { fg = p.fg2 })
  vim.api.nvim_set_hl(0, "SnacksDashboardIcon", { fg = p.fg2 })
  vim.api.nvim_set_hl(0, "SnacksDashboardTitle", { fg = p.light_red, bold = true })
  vim.api.nvim_set_hl(0, "SnacksDashboardFile", { fg = p.fg })
  vim.api.nvim_set_hl(0, "SnacksDashboardDir", { fg = p.red })
  ...
  vim.api.nvim_set_hl(0, "SnacksDashboardTerminalInputSearch", { fg = p.light_red })
  ...
  vim.api.nvim_set_hl(0, "SnacksPickerHeader", { fg = p.red, bg = p.bg, bold = true })
  vim.api.nvim_set_hl(0, "SnacksPickerIcon", { fg = p.red })
  vim.api.nvim_set_hl(0, "SnacksPickerIconDir", { fg = p.light_red })
  ...
  vim.api.nvim_set_hl(0, "SnacksPickerListTitle", { fg = p.crimson, bg = p.bg, bold = true })
  vim.api.nvim_set_hl(0, "SnacksPickerInput", { fg = p.fg, bg = p.bg })
  vim.api.nvim_set_hl(0, "SnacksPickerInputBorder", { fg = p.gray, bg = p.bg })
  vim.api.nvim_set_hl(0, "SnacksPickerInputSearch", { fg = p.light_red, bg = p.bg })
  ...
  vim.api.nvim_set_hl(0, "SnacksNotifierTitle", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "SnacksNotifierIcon", { fg = p.crimson })
  vim.api.nvim_set_hl(0, "SnacksNotifierBody", { fg = p.fg })
  vim.api.nvim_set_hl(0, "SnacksNotifierInfo", { fg = p.fg2 })
  vim.api.nvim_set_hl(0, "SnacksNotifierWarn", { fg = p.red })
  ...
  vim.api.nvim_set_hl(0, "SnacksTerminalTitle", { fg = p.light_red, bg = p.bg, bold = true })

  -- Input
  vim.api.nvim_set_hl(0, "SnacksInput", { fg = p.fg, bg = p.bg })
  vim.api.nvim_set_hl(0, "SnacksInputBorder", { fg = p.gray, bg = p.bg })
  vim.api.nvim_set_hl(0, "SnacksInputTitle", { fg = p.light_red, bg = p.bg, bold = true })
  vim.api.nvim_set_hl(0, "SnacksInputIcon", { fg = p.crimson })
  ...
  vim.api.nvim_set_hl(0, "SnacksExplorerTitle", { fg = p.red, bg = p.bg, bold = true })
  vim.api.nvim_set_hl(0, "SnacksExplorerDir", { fg = p.light_red, bold = true })
  ...
  vim.api.nvim_set_hl(0, "SnacksExplorerIconDir", { fg = p.light_red })
  ...
  vim.api.nvim_set_hl(0, "SnacksExplorerGitAdded", { fg = p.red })
  vim.api.nvim_set_hl(0, "SnacksExplorerGitModified", { fg = p.red })
  ...
  vim.api.nvim_set_hl(0, "SnacksScratchTitle", { fg = p.crimson, bg = p.bg, bold = true })

  -- Statuscolumn
  vim.api.nvim_set_hl(0, "SnacksStatusColumn", { fg = p.gray, bg = p.bg })
  vim.api.nvim_set_hl(0, "SnacksStatusColumnNumber", { fg = p.gray })
  vim.api.nvim_set_hl(0, "SnacksStatusColumnRelNumber", { fg = p.red })
  vim.api.nvim_set_hl(0, "SnacksStatusColumnGitAdd", { fg = p.red })
  vim.api.nvim_set_hl(0, "SnacksStatusColumnGitChange", { fg = p.red })
