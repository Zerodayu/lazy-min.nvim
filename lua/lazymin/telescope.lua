...
function M.apply()
	...
	-- Prompt
	vim.api.nvim_set_hl(0, "TelescopePromptNormal", { fg = p.fg1, bg = p.bg1 })
	vim.api.nvim_set_hl(0, "TelescopePromptBorder", { fg = p.gray, bg = p.bg1 })
	vim.api.nvim_set_hl(0, "TelescopePromptTitle", { fg = p.red, bg = p.bg1, bold = true })
	vim.api.nvim_set_hl(0, "TelescopePromptPrefix", { fg = p.crimson, bg = p.bg1, bold = true })
	vim.api.nvim_set_hl(0, "TelescopePromptCounter", { fg = p.fg3, bg = p.bg1 })
