...
function M.apply()
  ...
  vim.api.nvim_set_hl(0, "TodoBgTODO", { fg = p.bg1, bg = p.light_red, bold = true })
  vim.api.nvim_set_hl(0, "TodoFgTODO", { fg = p.light_red, bold = true })
  ...
  vim.api.nvim_set_hl(0, "TodoBgHACK", { fg = p.bg1, bg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "TodoFgHACK", { fg = p.red, bold = true })
  ...
  vim.api.nvim_set_hl(0, "TodoBgPERF", { fg = p.bg1, bg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "TodoFgPERF", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "TodoBgTEST", { fg = p.bg1, bg = p.crimson, bold = true })
  vim.api.nvim_set_hl(0, "TodoFgTEST", { fg = p.crimson, bold = true })

  -- Additional todo-comments.nvim variants
  vim.api.nvim_set_hl(0, "TodoSignTODO", { fg = p.light_red, bold = true })
  vim.api.nvim_set_hl(0, "TodoSignFIX", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "TodoSignFIXME", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "TodoSignHACK", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "TodoSignNOTE", { fg = p.fg2, italic = true })
  vim.api.nvim_set_hl(0, "TodoSignWARN", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "TodoSignPERF", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "TodoSignTEST", { fg = p.crimson, bold = true })
end
