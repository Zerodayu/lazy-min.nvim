...
function M.apply()
  ...
  -- Command line prompt
  vim.api.nvim_set_hl(0, "NoiceCmdlinePrompt", { fg = p.red, bold = true })
  ...
  vim.api.nvim_set_hl(0, "NoiceCompletionItemKindConstant", { fg = p.crimson })
  vim.api.nvim_set_hl(0, "NoiceCompletionItemKindReference", { fg = p.fg2 })
  vim.api.nvim_set_hl(0, "NoiceCompletionItemKindValue", { fg = p.red })
  ...
  vim.api.nvim_set_hl(0, "NoiceCompletionItemKindEvent", { fg = p.red })
  ...
  -- LSP progress
  vim.api.nvim_set_hl(0, "NoiceLspProgressClient", { fg = p.red, bold = true })
  vim.api.nvim_set_hl(0, "NoiceLspProgressSpinner", { fg = p.light_red })
  vim.api.nvim_set_hl(0, "NoiceLspProgressTitle", { fg = p.fg1 })

  -- Search
  vim.api.nvim_set_hl(0, "NoiceFormatProgressDone", { fg = p.red, bold = true })
